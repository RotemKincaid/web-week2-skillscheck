...
// Code Here
let doubled = myNumbers.map(i => i * 2);
console.log(doubled);
...
let filtered = myNumbers.filter(i => i > 100);
...
// let total = mynumbers.reduce(i => acc , cur  )
...
// Code Here
let myNumbersIndex = [];
myNumbers.forEach(function(elem, i) {
